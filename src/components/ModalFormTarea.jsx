...
const ModalFormularioTarea = () => {
    ...
    const { modalFormTarea, handleModalTarea, submitTarea, alerta, mostrarAlerta, tarea } = useProyectos()
    ...
    const handleSubmit = async e => {
        e.preventDefault()
        if(nombre.trim() === '' || descripcion.trim() === '' || fechaEntrega.trim() === '' || prioridad.trim() === '') {
            mostrarAlerta({
